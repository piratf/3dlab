...
function createStairs() {
	...
	var stepHalfThickness = stepThickness / 2;		//half of Thick
	var stepHalfHeight = verticalStepHeight / 2;	//half of Y
	var stepHalfHorizontal = horizontalStepDepth / 2;	//half of Z
	...
	for (var i = 0; i < 6; i++) {
		// +Y direction is up
 		...
 		stepMesh.position.y = stepHalfHeight + (i * verticalStepHeight) + (i * stepThickness);	// half of height: put it above ground plane
 		stepMesh.position.z = (i * 2) * (stepHalfHorizontal - stepHalfThickness);			// centered at origin
 		scene.add( stepMesh );
 		...
 		stepMesh.position.y = stepHalfThickness + (verticalStepHeight * (i + 1)) + (stepThickness * i);
 		// Push step forward by half the depth, minus half the vertical step's thickness
 		stepMesh.position.z = (i * 2 + 1) * (stepHalfHorizontal - stepHalfThickness);
 		scene.add( stepMesh );
	};
}
