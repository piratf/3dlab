...
function createSupport() {
	...
	var cubeMaterial = new THREE.MeshLambertMaterial( { color: 0xF07020, side: THREE.FrontSide } );
	// base
	var cube;
	cube = new THREE.Mesh(
	...
	cube.position.z = 77 + 3;	// offset 77 + half of depth 6/2
	scene.add( cube );
...
function createBody() {
	var sphereMaterial = new THREE.MeshLambertMaterial( { color: 0xA00000, side: THREE.FrontSide } );
	var cylinderMaterial = new THREE.MeshLambertMaterial( { color: 0x0000D0, side: THREE.FrontSide } );
	var sphereGeometry = new THREE.SphereGeometry( 52, 32, 16 );
	var cylinderGeometry = new THREE.CylinderGeometry( 10, 10, 334+52, 32 );
	var sphereMesh = new THREE.Mesh( sphereGeometry, sphereMaterial );
	sphereMesh.position.y = 160;
	scene.add(sphereMesh);
	var cylinderMesh = new THREE.Mesh( cylinderGeometry, cylinderMaterial );
	cylinderMesh.position.y = (334+52) / 2 + 160;
...
function createHead() {
	...
	var sphereGeometry = new THREE.SphereGeometry( 52, 32, 16 );
	var cylinderGeometryBase = new THREE.CylinderGeometry( 52 + 15, 52 + 15, 15, 32 );
	var cylinderGeometryBody = new THREE.CylinderGeometry( 52 - 10, 52 - 10, 52, 32 );
	var sphereMesh = new THREE.Mesh( sphereGeometry, sphereMaterial );
	sphereMesh.position.y = 160 + 334+52;
	scene.add(sphereMesh);

	var cylinderMeshBase = new THREE.Mesh( cylinderGeometryBase, cylinderMaterial );
	cylinderMeshBase.position.y = 160 + 334+52 + 52/2;
	scene.add(cylinderMeshBase);

	var cylinderMeshBody = new THREE.Mesh( cylinderGeometryBody, cylinderMaterial );
	cylinderMeshBody.position.y = 160 + 334+52 + 52;
	scene.add(cylinderMeshBody);
